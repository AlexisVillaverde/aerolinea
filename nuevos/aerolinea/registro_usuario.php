...
<div class="container">
    <form id="registroForm" class="formulario">
        <img src="skywings_logo.png" alt="Logo" class="logo">
...
document.getElementById('registroForm').addEventListener('submit', function(event) {
    ...
    formData.append('redirectUrl', redirectUrl); // Agrega la URL de redirección a los datos del formulario
    ...
    .then(data => {
        ...
        if (data.status === 'success') {
            ...
            setTimeout(() => {
                ...
                window.location.href = data.redirect || 'http://localhost/si/pry/Aerolinea/';
            }, 2000);
